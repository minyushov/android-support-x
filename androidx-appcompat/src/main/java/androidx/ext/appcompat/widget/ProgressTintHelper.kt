...
import androidx.ext.appcompat.R
import androidx.ext.core.graphics.drawable.wrap

internal class ProgressTintHelper(private val view: ProgressBar) {
  companion object {
    val DEFAULT_TINT_MODE = PorterDuff.Mode.SRC_IN

    fun create(progressBar: ProgressBar): ProgressTintHelper = ProgressTintHelper(progressBar)
  }
