package androidx.ext.appcompat.view
 ...
 * tinting calls from [ProgressBarCompat][msv.androidx.appcompat.widget.ProgressBarCompat]
...
internal interface TintableProgressBar {
   ...
   * tint mode using
   * [DrawableCompat.setTint][androidx.core.graphics.drawable.DrawableCompat.setTintList].
   *
   * @param tint the tint to apply, may be null to clear tint
   *
   * @see [getSupportIndeterminateTintList]
   * @see [androidx.core.graphics.drawable.DrawableCompat.setTintList]
   */
