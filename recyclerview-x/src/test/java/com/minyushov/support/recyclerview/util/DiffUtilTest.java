package com.minyushov.support.recyclerview.util;
...
public class DiffUtilTest {
  ...
  private void initWithSize(int size) {
    ...
    mLog.append("initWithSize(").append(size).append(");\n");
  }
  ...
  private List<Item> applyUpdates(List<Item> before, DiffUtil.DiffResult result) {
    final List<Item> target = new ArrayList<>(before);
